class Library:
  ...
  def __str__(self):
    return f"Biblioteka: {self.city}, {self.street}, {self.zip_code}, Godziny otwarcia: {self.open_hours}, Tel. kontakt. {self.phone}"
...
class Employee:
  ...
  def __str__(self):
    return (f"{self.first_name} {self.last_name}, zatrudniony: {self.hire_date}, urodzony: {self.birth_date}, "
            f"zamieszkały: {self.city}, {self.street}, {self.zip_code}, nr tel: {self.phone}")
...
class Book:
  ...
  def __str__(self):
    return (f" - Książka napisana przez: {self.author_name} {self.author_surname}, wydana: {self.publication_date}, "
...
class Order:
  ...
  def __str__(self):
    ...
    return (f"Zamówienie (dnia: {self.order_date} )\n"
...
class Student:
  ...
  def __str__(self):
    return (f"Student: {self.album_number} {self.first_name} {self.last_name}, Adres {self.city} {self.street}, {self.zip_code}")
